          ...
          <motion.div variants={viewVariants}>
            <div className="md:pt-12 space-y-4">
              ...
              <p className="text-[20px] md:text-3xl md:leading-10">
                ...
                Pudding muffin dessert jelly beans sugar plum wafer wafer.
                Soufflé cake sweet jelly beans tiramisu caramels cake sesame
                snaps. Marshmallow jujubes brownie gummies topping tiramisu.
                Sweet shortbread croissant caramels lemon drops jelly. Sweet
                candy powder dessert tart carrot cake. Bonbon lollipop cupcake
                marshmallow powder chocolate bar cake soufflé.
              </p>
            </div>
          </motion.div>
        </motion.div>
                ...
                <motion.div variants={viewVariants}>
                  <div className="lg:flex space-y-3 lg:space-y-0">
                    ...
                    <p className="text-[16px]">
                      Sweet roll cupcake liquorice cotton candy croissant
                      halvah. Jujubes donut sweet roll chocolate cake wafer
                      liquorice lollipop sesame snaps. Oat cake marzipan
                      chocolate pastry wafer jujubes bear claw sweet liquorice.
                      Lemon drops chupa chups halvah bear claw candy gummi bears
                      topping tootsie roll.
                    </p>
                  </div>
                </motion.div>
              </motion.div>
                ...
                <motion.div variants={viewVariants}>
                  <div className="lg:flex space-y-3 lg:space-y-0">
                    ...
                    <p className="text-[16px]">
                      ...
                      powder cake cake dessert cake. Cake cake muffin tootsie
                      roll carrot cake dragée marshmallow candy canes. Sweet
                      roll croissant cookie sweet roll dessert dessert topping.
                      Sesame snaps gummies muffin croissant candy pie. Bear claw
                      chupa chups cotton candy gummi bears marshmallow.
                    </p>
                  </div>
                </motion.div>
              </motion.div>
